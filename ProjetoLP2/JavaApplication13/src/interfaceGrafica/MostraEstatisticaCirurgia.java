...
/*
 * MostraEstatisticaCirurgia.java
 *
 * Created on 25/11/2010, 14:45:40
 */
 ...
 * @author rodolfolv
 */
public class MostraEstatisticaCirurgia extends javax.swing.JPanel {

    /** Creates new form MostraEstatisticaCirurgia */
    public MostraEstatisticaCirurgia() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Main.estatistica.estatiscasCirurgia(especialidade(especia.getSelectedItem().toString()));

        Main.mostraEstatisticaCirurgia = new MostraEstatisticaCirurgia();
        Main.frame1.setContentPane(Main.mostraEstatisticaCirurgia);
        Main.frame1.setVisible(true);
